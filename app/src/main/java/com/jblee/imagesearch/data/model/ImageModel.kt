...
data class ImageModel(
    ...
    val documents: ArrayList<Document>, // MutableList로 안하고 ArrayList로 하는구나
     ...
     */
    data class Document(
        @SerializedName("collection") // SerailizedName은 해당 data class 내에서 쓸 변수 이름이 다른 것을 대비하여 쓰는건데, 만약에 변수도 이름이 같게 지정하면 annotation을 쓰지 않아도 된다.
